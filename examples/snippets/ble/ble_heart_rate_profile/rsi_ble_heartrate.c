...
//sensor location
#define RSI_BLE_BODY_SENSOR_LOCATION_OTHER    0
#define RSI_BLE_BODY_SENSOR_LOCATION_CHEST    1
#define RSI_BLE_BODY_SENSOR_LOCATION_WRIST    2
#define RSI_BLE_BODY_SENSOR_LOCATION_FINGER   3
#define RSI_BLE_BODY_SENSOR_LOCATION_HAND     4
#define RSI_BLE_BODY_SENSOR_LOCATION_EAR_LOBE 5
#define RSI_BLE_BODY_SENSOR_LOCATION_FOOT     6
